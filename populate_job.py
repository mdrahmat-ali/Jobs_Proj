...
def populate(n):
    for i in range(n):
        ...
        ftitle=fake.random_element(elements=('Project Manager','Teamleader','Software Engineer'))
        ...
        bangalorejobs_record=bangalorejobs.objects.get_or_create(date=fdate,company=fcompany,title=ftitle,eligibility=feligibility,address=faddress,email=femail,phonenumber=fphonenumber)
